...
sshpass -p $INPUT_PASSWORD rsync -o StrictHostKeyChecking=no -vzr --delete --exclude '.*' $INPUT_LOCAL_DIR $INPUT_USERNAME@acsweb.ucsd.edu:~/public_html/$INPUT_REMOTE_DIR
